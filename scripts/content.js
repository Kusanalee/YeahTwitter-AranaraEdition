                ...
                try {
                    ...
                    if(res === 'success') {
                        ...
                        let modal2 = createModal(/*html*/`
                            ...
                            <div>
                                btw I (<a href="/d1mden" target="_blank" style="text-decoration:none;color:#1d9bf0">@d1mden</a>) make a lot of cool extensions for Twitter like this, maybe u wanna follow me? - do check them out! (p.s. this aranara extension was made by @Kusanaliee on Twitter so if you want to see aranara posting, you can follow)
                            </div>
